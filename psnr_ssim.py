...
def psnr_ssim_dir(gt_dir, test_dir):
    ...
    for gt_name, test_name in zip(gt_img_list, test_img_list):
        ...
        print(gt_img_list[count],"psnr is:",PSNR(gt_img, test_img))
        print(gt_img_list[count], "ssim is:", SSIM(gt_img, test_img))
        count += 1
    return psnr_score / len(gt_img_list), ssim_score / len(gt_img_list)

if __name__ == '__main__':
    '''
    gt_dir = "/home2/ZiXiangXu/Last_ding/spation_test_1000/"
    test_dirs = [
                  "/home2/ZiXiangXu/Last_ding/res4/epoch_CelebA/"
            ]
    '''
    
    gt_dir = "image_origin/Celeba_HR"
    test_dirs = [
                   "result/492800"
            ]
