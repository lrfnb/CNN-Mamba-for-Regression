...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--visual_freq', type=int, default=400,
                            help='frequency of show training images in tensorboard')
        parser.add_argument('--print_freq', type=int, default=100,
                            help='frequency of showing training results on console')
        # network saving and loading parameters
        parser.add_argument('--save_iter_freq', type=int, default=10000, help='frequency of saving the models')
        ...
        parser.add_argument('--gan_mode', type=str, default='hinge',
                            help='the type of GAN objective. [vanilla| lsgan | hinge]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.')
        ...
        #                     help='learning rate for regression network')
        ...
        #                     help='use log scale for resolution values')
        # parser.add_argument('--base_resolution', type=float, default=0.1,
        #                     help='base resolution in m/px')
        self.isTrain = True
